...
public class TextValidator {
     ...
     * 只能为英文和数字
     */
    private static final String REGEX_ENANDNUM = "^[A-Za-z0-9\\-]+$";
    private static final Pattern PATTERN_REGEX_ENANDNUM = Pattern.compile(REGEX_ENANDNUM);
    ...
    public static boolean isEnAndNum(CharSequence input) {
        return isMatch(PATTERN_REGEX_ENANDNUM, input);
    }
    ...
    public static void main(String[] args) {
        System.out.println(isMatch(PATTERN_REGEX_ENANDNUM,"章edfd0009"));
        System.out.println(TextValidator.isEnAndNum("！！@Edfd0009"));
    }
}
