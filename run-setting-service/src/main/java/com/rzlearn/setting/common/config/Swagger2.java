package com.rzlearn.setting.common.config;
...
public class Swagger2 {
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.rzlearn"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("ruihu", "https://www.bj-elearning.com/", "manager@bj-elearning.com"))
                .version("1.0")
                .build();
    }
